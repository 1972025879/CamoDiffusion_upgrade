...
if __name__ == '__main__':
    ...
    # 执行两个任务（顺序）
    main(cmd='bash ./train_Initiate.sh', required_gpu_count=args.count, memory_threshold=args.threshold, specified_gpus=args.gpus)
    main(cmd='bash ./train_2_Initiate.sh', required_gpu_count=args.count, memory_threshold=args.threshold, specified_gpus=args.gpus)