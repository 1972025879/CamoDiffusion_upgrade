...
class FeedForward(nn.Module):
    def __init__(self, dim, ffn_expansion_factor, bias):
        ...
        self.dwconv = nn.Conv2d(hidden_features*2, hidden_features*2, kernel_size=3, stride=1, padding=1, groups=hidden_features*2, bias=bias) #每一个输入通道只用自己的数据做卷积，不与其他通道混合。 这就是所谓的 depthwise conv。 
...
class Attention(nn.Module):
    def __init__(self, dim, num_heads, bias,mode):
        ...
        # 1x1卷积：通道混合
        # 3x3卷积：空间邻域信息聚合 是深度可分离卷积 减少了运算量
...
class Decoder_Transformer(nn.Module):
    ...
    def forward(self, E4, E3, E2, E1,shape):
        E4, E3, E2, E1= self.side_conv1(E4), self.side_conv2(E3), self.side_conv3(E2), self.side_conv4(E1) #统一通道
        ...
        E5 = self.conv_block(E4, E3, E2) #3c>c>2c>c ,kernelsize= 3,5,3
